...
# 2.0 â‰ˆ 95th percentile (two-sided), standard SPC convention.
...
class AnomalyRecord:
    ...
    expected: float        # media histÃ³rica
    std_dev: float         # desvÃ­o estÃ¡ndar histÃ³rico
...
def _severity_for_z(z: float) -> str:
    ...
    The thresholds are the SPC-standard ones (2Ïƒ, 3Ïƒ), chosen deliberately
